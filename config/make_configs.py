...
datasets = ["snips_GetWeather_BO","snips_SearchCreativeWork_BO","snips_RateBook_BO","snips_PlayMusic_BO","snips_SearchScreeningEvent_BO","snips_BookRestaurant_BO"]
ori_config_dir = "snips_AddToPlaylist_BO.json"
